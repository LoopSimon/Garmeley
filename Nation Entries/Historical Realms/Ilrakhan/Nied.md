...
<div class="wiki-infobox">
    <h4 class="wiki-header">Duchy of Nied</h4>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span> <a href="Trinicism" class="internal-link">Trinicism</a> & <a href="Gethricism" class="internal-link">Gethricism</a></span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span><a href="Urland" class="internal-link">Urland</a></span>
    </div>
    <div class="wiki-row">
        <strong>Formed</strong>
        <span>As Urlander Duchy: 332PA,<br>
        Independently: 696PA</span>
    </div>
    <div class="wiki-row">
...
<p>The two armies met at Tongmill , a few miles south of Niedrest and as many of the dukes own warriors turned against him, the Councils Free army was left victorious. With the Duke captured and many of the nobility that followed him fallen on the battlefield of executed posthaste, the Burghers support by opportunistic patricians and so far neutral noble in the various other surrounding cities of the Duchy rose sharply and over the following months and years the old order was exchanged, although only Niedrest itself cleansed itself almost entirely from the blue blooded elite. Years later, with fighting against resisting forces largely quenched, the appeased Cities proclaimed the Union of the Trinvale Republics, a name largely theatrical considering that only Niedrest and Lindahall ever held elections and even then they were essentially a bribery competition between a handful of rich merchant dynasties.</p>