...
<div class="wiki-infobox">
    <h4 class="wiki-header">Sihilixar</h4>
    <div class="wiki-row">
        <strong>Government</strong>
        <span>Eternal Despotate</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span>White claw on crimson ground</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
        <strong>Primary Religion</strong>
        <a href="Voluntism" class="internal-link">Sihiri Voluntism</a>
    </div>
    <div class="wiki-row">
        <strong>Primary Culture</strong>
        <span><a href="Peruxa" class="internal-link">Nirydian Peruxa</a></span>
    </div>
    <div class="wiki-row">
        <strong>Official Language</strong>
        <span>Nirydian Curux</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
