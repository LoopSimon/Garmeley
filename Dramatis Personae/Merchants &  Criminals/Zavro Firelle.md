...
<div class="wiki-infobox">
    <h4 class="wiki-header">Zavro Firelle</h4>
    <div class="wiki-row">
        <strong>Occupation</strong>
        <span>Owner of Firelle Wines</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span>Vineyard Proprietor,<br> Wine Sales</span>
    </div>
    <hr class="wiki-hr">
	<img src="https://raw.githubusercontent.com/LoopSimon/Garmeley/refs/heads/main/Media/Firelle.jpg" style="width: 100%; height: 100%; object-fit: cover; display: block; flex-grow: 1;"> 
