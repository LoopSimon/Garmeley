...
<div class="wiki-infobox">
    ...
    <div class="wiki-row">
        ...
        <span>Queen of <a href="Skemfing" class="internal-link">Skemfing</a></span>
    </div>
    <div class="wiki-row">
        <strong>Culture</strong>
        <span><a href="Aelf" class="internal-link">Aelf</a></span>
    </div>
    <div class="wiki-row">
        <strong>Born</strong>
        <span>99PA, Skemfing</span>
	    </div>
    <div class="wiki-row">
        <strong>Died</strong>
        <span>alive</span>
    ...
    <div class="wiki-row">
        <strong>Issue</strong>
        <span>Laettr, <a href="Skemril" class="internal-link">Skemril</a>, Ravel</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span><a href="Skemfing" class="internal-link">Skemfing</a></span>
    </div>
    <hr class="wiki-hr">
