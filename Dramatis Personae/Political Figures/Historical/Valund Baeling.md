...
<div class="wiki-infobox">
    ...
    <div class="wiki-row">
        ...
        <span>Emperor of the Baeling</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        <strong>Born</strong>
        <span>431PA, unknown</span>
	    </div>
    <div class="wiki-row">
        <strong>Died</strong>
        <span>499PA, Alsebyn</span>
    </div>
    <div class="wiki-row">
        <strong>Cause of Death</strong>
        <span>Stroke, <br> 66 years of age</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
        <strong>Issue</strong>
        <span>Erik Baeling,<br> Berisa Baeling, <br> Håkan Baeling</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span><a href="Baeling Empire" class="internal-link">Baeling Empire</a></span>
    </div>
    <hr class="wiki-hr">
