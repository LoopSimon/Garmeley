...
<div class="wiki-infobox">
    <h4 class="wiki-header">Zovac Harlini</h4>
    <div class="wiki-row">
        <strong>Epitath</strong>
        <span>Marblehand</span>
    </div>
    <div class="wiki-row">
        <strong>Occupation</strong>
        <span>Archmage of Edessa Tower,<br>Kar-Zavr of Vihr,<br>Gri of Direszk</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        <strong>Born</strong>
        <span>728PA, Direszk</span>
	    </div>
    <div class="wiki-row">
        <strong>Died</strong>
        <span>presumably 799PA, Edessa Tower</span>
    </div>
    <div class="wiki-row">
        <strong>Cause of Death</strong>
        <span>Vanished<br>71 years of Age</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
        <strong>Field of Research</strong>
        <span>Realmatic Theory,<br>Harlinic Space,<br>Weaving,<br>Dulmic Transistors</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span><a href="Carassa al-Kael" class="internal-link">Carassa al-Kael</a>, <br><a href="Jevana" class="internal-link">Jevana of Leston</a>, <br> Jan Midroviz</span>
    </div>
    <hr class="wiki-hr">
    <img src="https://raw.githubusercontent.com/LoopSimon/Garmeley/refs/heads/main/Media/Harlini.jpg" style="width: 100%; height: 100%; object-fit: cover; display: block; flex-grow: 1;"> 
