...
<div class="wiki-infobox">
    <h4 class="wiki-header">Kasthemis of Lorqis</h4>
    <div class="wiki-row">
        <strong>Occupation</strong>
        <span>Philosopher and Scientist</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        <strong>Died</strong>
        <span>658BA, <a href="Lorqis" class="internal-link">Lorqis</a></span>
    </div>
    <div class="wiki-row">
        <strong>Cause of Death</strong>
        <span>Aneurysm,<br>ca. 73 Years of Age</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
        <strong>Field of Research</strong>
        <span>Geography, Astronomy</span>
    </div>
    <hr class="wiki-hr">
