...
<div class="wiki-infobox">
    ...
    <div class="wiki-row">
        ...
        <span>Professor at Hevn University</span>
    </div>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span>Energy Classification,<br>Geomancy</span>
    </div>
    <div class="wiki-row">
        <strong>Known Teachers</strong>
        <span>Harri Kohlsten</span>
    </div>
    <div class="wiki-row">
    ...
    <hr class="wiki-hr">
	<img src="https://raw.githubusercontent.com/LoopSimon/Garmeley/refs/heads/main/Media/swarn.png" style="width: 100%; height: 100%; object-fit: cover; display: block; flex-grow: 1;"> 
