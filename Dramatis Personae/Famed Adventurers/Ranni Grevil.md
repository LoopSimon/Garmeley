...
<div class="wiki-infobox">
    ...
    <div class="wiki-row">
        <strong>Born</strong>
        <span>895PA, Halgrach</span>
	    </div>
    <div class="wiki-row">
        <strong>Died</strong>
        <span>827PA, eelers Inn</span>
    </div>
    <div class="wiki-row">
        <strong>Cause of Death</strong>
        <span>fell to fey magic, aged 32</span>
    </div>
    <hr class="wiki-hr">
    <div class="wiki-row">
    ...
    <hr class="wiki-hr">
	<img src="https://raw.githubusercontent.com/LoopSimon/Garmeley/refs/heads/main/Media/Ranni_1.png" style="width: 100%; height: 100%; object-fit: cover; display: block; flex-grow: 1;"> 
