...
<div class="wiki-infobox">
    <h4 class="wiki-header">Egill Bylgjurek</h4>
    <div class="wiki-row">
    ...
    <div class="wiki-row">
        ...
        <span><a href="Fjorisjom Saga" class="internal-link">The Fjorisjom</a>,<br><a href="Nyllena" class="internal-link">Champion of Nyllena</a>
    </div>
    <div class="wiki-row">
        <strong>Issue</strong>
        <span>unknown</span>
    ...
    <hr class="wiki-hr">
	<img src="https://raw.githubusercontent.com/LoopSimon/Garmeley/refs/heads/main/Media/Waveblade.jpg" style="width: 100%; height: 100%; object-fit: cover; display: block; flex-grow: 1;"> 
